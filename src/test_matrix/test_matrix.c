...
START_TEST(s21_create_matrix_test) {
  int data[3] = {1, 2, 3};
  FILE *fp = fopen("test_matrix/data/s21_create_matrix_data.txt", "r");
  if (fp) {
    for (int k = 0; k < 3; k++) {
      for (int l = 0; l < 3; l++) {
...
START_TEST(s21_sum_matrix_test) {
  ...
  FILE *fp = fopen("test_matrix/data/s21_sum_matrix_data.txt", "r");
  if (fp) {
    char matrix_str[1024] = {'\0'};
    char str_original[1024] = {'\0'};
    for (int i = 0; i < 5; i++) {
...
START_TEST(s21_sub_matrix_test) {
  ...
  FILE *fp = fopen("test_matrix/data/s21_sub_matrix_data.txt", "r");
  if (fp) {
    char matrix_str[1024] = {'\0'};
    char str_original[1024] = {'\0'};
    for (int i = 0; i < 5; i++) {
...
START_TEST(s21_mult_number_test) {
  ...
  FILE *fp = fopen("test_matrix/data/s21_mult_number_matrix_data.txt", "r");
...
START_TEST(s21_mult_matrix_test) {
  ...
  FILE *fp = fopen("test_matrix/data/s21_mult_matrix_data.txt", "r");
  if (fp) {
    char matrix_str[1024] = {'\0'};
    char str_original[1024] = {'\0'};
    for (int i = 0; i < 5; i++) {
...
START_TEST(s21_mult_matrix_test_error) {
  ...
  s21_create_matrix(3, 4, &matrix[3]);
  s21_create_matrix(3, 4, &matrix[4]);
...
START_TEST(s21_transpose_matrix_test) {
  ...
  FILE *fp = fopen("test_matrix/data/s21_transpose_matrix_data.txt", "r");
  if (fp) {
    char matrix_str[1024] = {'\0'};
    char str_original[1024] = {'\0'};
    for (int i = 0; i < 3; i++) {
...
START_TEST(s21_calc_complements_test) {
  ...
  FILE *fp = fopen("test_matrix/data/s21_calc_complements_data.txt", "r");
  if (fp) {
    char matrix_str[1024] = {'\0'};
    char str_original[1024] = {'\0'};
    fgets(str_original, sizeof(str_original), fp);
...
START_TEST(s21_inverse_matrix_test_1x1) {
  matrix_t matrix = {0};
  ...
  ck_assert_float_eq(res.matrix[0][0], 0.2);
  s21_remove_matrix(&matrix);
  s21_remove_matrix(&res);
}
END_TEST

Suite *test_suite_s21_inverse_matrix_1x1() {
  Suite *s = suite_create("test_suite_s21_inverse_matrix_1x1");
  TCase *tc = tcase_create("test_suite_s21_inverse_matrix_1x1");
  tcase_add_test(tc, s21_inverse_matrix_test_1x1);
  suite_add_tcase(s, tc);
  return s;
}
...
START_TEST(s21_inverse_matrix_test_2x2) {
  ...
  FILE *fp = fopen("test_matrix/data/s21_inverse_matrix_2x2_data.txt", "r");
  if (fp) {
    char matrix_str[1024] = {'\0'};
    char str_original[1024] = {'\0'};
...
START_TEST(s21_inverse_matrix_test_3x3) {
  ...
  FILE *fp = fopen("test_matrix/data/s21_inverse_matrix_3x3_data.txt", "r");
  if (fp) {
    char matrix_str[1024] = {'\0'};
    char str_original[1024] = {'\0'};
    fgets(str_original, sizeof(str_original), fp);
...
START_TEST(s21_inverse_matrix_test_4x4) {
  ...
  FILE *fp = fopen("test_matrix/data/s21_inverse_matrix_4x4_data.txt", "r");
  if (fp) {
    char matrix_str[1024] = {'\0'};
    char str_original[1024] = {'\0'};
    fgets(str_original, sizeof(str_original), fp);
...
START_TEST(s21_inverse_matrix_test_5x5) {
  ...
  FILE *fp = fopen("test_matrix/data/s21_inverse_matrix_5x5_data.txt", "r");
  if (fp) {
    char matrix_str[1024] = {'\0'};
    char str_original[1024] = {'\0'};
    fgets(str_original, sizeof(str_original), fp);
...
START_TEST(s21_inverse_matrix_test_6x6) {
  ...
  FILE *fp = fopen("test_matrix/data/s21_inverse_matrix_6x6_data.txt", "r");
  if (fp) {
    char matrix_str[1024] = {'\0'};
    char str_original[1024] = {'\0'};
    fgets(str_original, sizeof(str_original), fp);
...
int main() {
  ...
  Suite *test_suites[] = {test_suite_s21_create_matrix(),
                          ...
                          test_suite_s21_inverse_matrix_1x1(),
